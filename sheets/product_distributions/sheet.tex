...
\ssection{Example: fair coin repeated flips}

Suppose we want to model a coin flipped $n$ times.
Supposing the coin is fair (see \sheetref{probability_distribtuions}{Probability Distributions}) we might use our probability distribution $p: \set{0, 1} \to [0, 1]$ which assigned $p(0) = p(1) = \nicefrac{1}{2}$.
