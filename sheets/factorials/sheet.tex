...
We have considered the number of ways we can arrange 52 cards into a deck.
What of $n$ cards?
A moment's reflection indicates this will also be the number of ways to arrange $n$ objects in order (where the objects need not be cards).
