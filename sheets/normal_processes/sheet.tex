...
A \t{normal process} (or \t{gaussian process})\footnote{The choice of \say{normal} is a result of the Bourbaki project's convention to eschew historical names. Though here, as in \sheetref{multivariate_normals}{Multivariate Normals} the language of the project is nonstandard.} $x: I \to (\Omega \to \R)$ on $I$ is a family of real-valued random variables with the property that any subset of the range of this family has a multivariate normal density.
