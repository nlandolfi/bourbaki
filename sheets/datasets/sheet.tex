...
Thus we use the \say{dataset,} as a single word.
...
A minor other point is that \say{data} is the plural form of a latin noun, and so is analgous to saying something like \say{records set,} instead of something like \say{record set.}
