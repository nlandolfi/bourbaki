...
\begin{proposition}
$\powerset{A} \cap  \powerset{F} = \powerset{(A \cap  F)}$\end{proposition}
\begin{proposition}
$\bigcap_{X \in \mathcal{A} } \powerset{A} = \powerset{(\bigcap_{X \in \mathcal{A} } A)}$\end{proposition}
\begin{proposition}
$\bigcap_{X \in \powerset{E}} X = \emptyset$\end{proposition}
\blankpage