...
Let $X$ be the set of people and let $R$ be the relation in $X$ \say{is a brother of} and $S$ be the relation in $X$ \say{is a father of}.
Then $RS$ is the relation \say{is an uncle of}.
