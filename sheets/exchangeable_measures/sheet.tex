...
A first measure is \t{exchangeable} with respect to a second measure if the first measure of any measurable set is zero whenever the second measure of that set is zero.\footnote{The language \say{exchangeable} is not at all standard. We have coined it for the reasons outlined in the why of this sheet.}
