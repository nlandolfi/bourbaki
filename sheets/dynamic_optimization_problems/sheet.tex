...
%!need:controlled_dynamical_systems
% below is no longer needed, moved to stochastic dynamical systems
...
Although these models include no notion of ``uncertainty'' (or ``uncertain outcomes'', see \sheetref{uncertain_outcomes}{Uncertain Outcomes}), they are frequently applied in situations with uncertain outcomes by ignoring the uncertainty in the application.
