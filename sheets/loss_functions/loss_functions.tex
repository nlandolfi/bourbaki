...
A \ct{loss function}{} is a nonnegative
...
The \ct{loss of a predictor on a pair}{} is the
result of the loss function on the pair.
Similarly, the \ct{loss of a predictor on  a sequence}{} of
pairs is the sum of the losses on the pairs.
The \ct{average loss of a predictor on a sequence}{} is
