...
\begin{proposition}[Chordal Graphs and Vertex Separators]
An undirected graph is chordal if and only if all minimal vertex separators are complete.\end{proposition}
