...
for finite measures.\end{proof}\end{proposition}
\begin{proposition}
The variance of a square-integrable real-valued random variable is the expectation of the square of the difference between the random variable and its expectation.\end{proposition}
\blankpage