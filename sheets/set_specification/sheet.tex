...
\begin{principle}[Specification]For any statement and any set, there is a subset whose elements satisfy the statement.\end{principle}
...
The principle of extension (see \sheetref{set\_equality}{Set Equality}) says that this set is unique.
All our basic principles about sets (other than the principle of extension, see \sheetref{set\_equality}{Set Equality}) assert that we can construct new sets out of old ones in reasonable ways.
...
\begin{proposition}No set contains all sets.
