...
Consider the simple $\neg$.
We will agree that it means \say{not}, in the sense of negating whatever it follows.
If we want to say the opposite of a simple statement like $a = b$ we will write $\neg(a = b)$.
We read it aloud as \say{not a is b}.
Of course, the more desirable english expression is \say{a is not b}.
...
For example $(a \in A) \implies (a \in B)$ means \say{the object denoted by $a$ belongs to the object denoted by $A$ implies the obejcted denoted by $a$ belongs to the set denoted by $B$}
