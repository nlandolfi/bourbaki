...
Again, the more desirable pronunciation goes \say{the object denoted by $a$ does not belong to the set $A$.}
...
The symbol $\iff$ means \say{if and only if}.\footnote{Future editions will expand.}
