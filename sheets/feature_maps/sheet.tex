...
These are sometimes called \t{basis functions}, by analogy with real function approximators (see \sheetref{real_function_approximators}{Real Function Approximators}).
...
Let $\mathcal{G}  = \set{g_{\theta }: \R ^d \to \R }_{\theta }$.
