...
\begin{proposition}[Recursion Theorem\footnote{Future editions will likely change this name.}]
Let $X$ be a set, let $a \in X$ and let $f: X \to X$.
  There exists a unique function $u$ so that $u(0) = a$ and $u(\ssuc{n}) = f(u(n))$.\footnote{The account is somewhat straightforward, given a good understanding of the results of \sheetref{peano_axioms}{Peano Axioms}. The full account will appear in future editions.}
\end{proposition}
