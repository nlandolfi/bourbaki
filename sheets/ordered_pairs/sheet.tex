...
\begin{proposition}
  $(((a, b) = (x, y)) \iff (a = x \land b = y))$\footnote{The proof of this proposition will be found in future editions.%the proof can be found in Halmos p23 right after the definition section 6
}
\end{proposition}
