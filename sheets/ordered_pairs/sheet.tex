...
\begin{proposition}
  $(a, b) = (c, d)$ if and only if $a = b$ and $c = d$.\footnote{The proof of this proposition will be found in future editions.%the proof can be found in Halmos p23 right after the definition section 6
}
\end{proposition}
