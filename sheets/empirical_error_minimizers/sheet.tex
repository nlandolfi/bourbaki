...
\ssection{Overfitting and incutive bias}
...
For any training set $(x_1, y_1), \dots, (x_n, y_n)$ in $X \times Y$, the hypothesis $h: X \to Y$ defined by $h(x) = y_i$ if $x = x_i$ and $h(x) = 0$ otherwise achieves zero empirical error but has \say{actual} error $\nicefrac{1}{2}$.
