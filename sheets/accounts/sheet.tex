...
We use the words \say{let \_ denote an \_} to introduce a name as a placeholder for a thing, and we use the symbols $\_=\_$ and $\_\in\_$ to denote statements of identity and belonging.
...
In these sheets, we will use \t{accounts}, which will be a list of statements, each of which is labeled by an Arabic numeral (see \sheetref{letters}{Letters}).
...
For logical statements we \say{have}, we write \texttt{have} followed by the logical statement.
So we write:
