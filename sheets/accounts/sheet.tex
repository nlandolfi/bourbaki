...
We use the words \say{let \_ denote a(n) \_} to introduce a name as a placeholder for a thing, and we use the symbols $\_=\_$ and $\_\in\_$ to denote statements of identity and belonging.
