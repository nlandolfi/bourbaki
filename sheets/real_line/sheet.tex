...
\begin{principle}[Point Sets]Given a line, there exists a set of its (infinite) points.\end{principle}
\begin{principle}[Real Line Correspondence]Let $P$ be the set of points for a line.
There exists a one-to-one correspondence mapping elements of $P$ onto elements of $\R $.\end{principle}
