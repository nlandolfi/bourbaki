...
They can be derived as for unions, or from the facts of unions using generalized DeMorgan's laws (see \sheetref{generalized_set_dualities}{Generalized SSet Dualities}.
