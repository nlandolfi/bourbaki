...
%!need:real_matrices
%!refs:sanjay_lall∕introduction_to_machine_learning∕classifiers
...
The off-diagonal entries give the numbers of incorrect predictions for the two types of errors (see \sheetref{classifier\_errors}{Classifier Errors}).
