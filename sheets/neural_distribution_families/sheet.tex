...
A \t{neural conditional distribution family} (or \t{deep conditional distribution family}) is a parameterized conditional distribution family whose parameterizer is a neural network (see \sheetref{parameterized\_distributions}{Parameterized Distributions} and \sheetref{neural\_networks}{Neural Networks}).
