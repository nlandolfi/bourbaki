...
In the usual notation, $(a, b)$ represents \say{$a/b$}.
...
We denote the set of rationals by $\Q $.\footnote{From what we can tell, $\Q $ is a mnemonic for \say{quantity,}from the latin \say{quantitas.}}
