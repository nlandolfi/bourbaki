...
Future editions will change this why. In particular, by referencing \sheetref{inverse_elements}{Inverse Elements} and the lack thereof in $\omega $.
  }
...
Briefly, the intuition is that $(a, b)$ represents $a$ less $b$, or in the usual notation \say{$a - b$}.
  \ifhmode\unskip\fi\footnote{
