...
%!name:natural_order
%!need:peano_axioms
%!wiki:https://en.wikipedia.org/wiki/Natural_number#Order
...
\begin{proposition}
For any two natural numbers, exactly one of $m \in n$, $m = n$ and $n \in m$ is true.\footnote{Use the fact that no natural number is a subset of itself. Future editions will expand this account. See \sheetref{peano_axioms}{Peano Axioms}).}\end{proposition}
\begin{proposition}
