...
Let $A$ be a set and let $\leq$ be an order\footnote{To be defined in future editions, but understood in the usual way. See \sheetref{natural_order}{Natural Order}or \sheetref{integer_order}{Integer Order}or \sheetref{rational_order}{Rational Order}etc.}
on $A$.
