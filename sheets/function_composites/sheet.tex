...
We denote the composition of $g$ with $f$ by $g \circ f$ read aloud as ``g composed with f.
...
Then $(f \circ g) \circ h = f \circ (g \circ h)$\footnote{The proof is straightforward. Future editions will include it.}
\end{proposition}
