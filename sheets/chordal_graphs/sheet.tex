...
We interpret a chord as a ``one-edge shortcut'' between two vertices of a path.
If a path $p$ has a chord, it can be reduced to a shorter path $p'$ by ``skipping'' vertices.
