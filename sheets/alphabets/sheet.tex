...
For example, $(c,a,t,s)$ is a word in $\mathcal{A} $ (meant to correspond to the word \say{cats}) and
    \[
((c,a,t,s), (a,n,d), (d,o,g,s))
    \]
is a phrase in $\mathcal{A} $ (meant to correspond to the phrase \say{cats and dogs}).
