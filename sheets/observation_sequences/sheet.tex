%!name:observation_sequences
%!need:datasets
%!need:integer_numbers
%!need:vectors
%!need:real_numbers
%!refs:david_brillinger/time_series_data_analysis_and_theory/01_the_nature_of_time_series_and_their_frequency_analysis
