...
Can we generalize the idea of flash codes.\footnote{The reliance of this sheet on \sheetref{flash_codes}{Flash Codes}and \sheetref{dot-dash_codes}{Dot-Dash Codes}is for this justification, and not for any of the terms presented.}

\section*{Definition}

Let $X$ be a set and $A$ be an alphabet set.
We denote the set of all finite sequences (strings) in $A$ by $\str(A)$.
We read $\str(A)$ aloud as \say{the strings in $A$.}
