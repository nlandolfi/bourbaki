...
\begin{proposition}
There exists a unique linear least squares predictor and its parameters are given by $(X^\top X)^{-1}X^\top y$.\footnote{Future editions will include an account.}\end{proposition}
\blankpage