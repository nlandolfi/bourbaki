...
Likewise, some authors refer to the argument to the inductor as the \t{training data}, \t{training set},\footnote{The use of the word \say{set} is rough, since we are really speaking of a sequence.} or \t{training examples}.
