%!name:distance_asymmetry
%!need:distance

\ssection{Why}

Sometimes \say{distance} as used in the English language
refers to an asymmetric  concept.
This apparent paradox further illuminates the symmetry property.

\ssection{Apparent Paradox}

Distance in the plane is symmetric: the distance from
one point to another does not depend on the order of the
...
The \say{distance} between these two points, the top of the hill and a point on its base, may not be symmetric with respect to the time taken or the effort involved.
...
It may justify, in the English phrase, \say{going around, rather than going over.}
