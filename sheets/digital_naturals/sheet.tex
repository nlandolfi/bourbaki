...
\ssection{Correspondence with $\N \union \set{0}$}
...
\ssection{Correspondence between $d$ and $k > d$ bit naturals }
...
\ssection{Addition}
% write now, natural sums comes as a need through bit strings, but this could change in the future.
