...
In line with this usage, the outputs are often called \t{labels} and the labels are said \say{\t{supervise}} or \say{to provide supervision.}
...
This language intends to indicate that inputs are given along with outputs, and these outputs \say{provide supervision to the algorithm.}
