...
We want to build vectors out of other vectors; using only scalar multiplication and vector addition.
...
The \t{result} of a linear combination is the sum of the results of scaling each vector by the corresponding scalar in the sequence.
So the result of a linear combination is a vector in the space.
