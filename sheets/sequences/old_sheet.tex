...
\ssection{Slices\footnote{Future editions may break sequences in finite sequences and infinite sequences. This would simplify the sheet and remove the dependence on the principle of infinity. Future editions may also use the term \say{list} instead of finite sequence.}}
