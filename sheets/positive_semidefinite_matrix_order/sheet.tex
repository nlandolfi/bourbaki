...
%!need:positive_semidefinite_cone
%!need:orders
...
In other words, $\geq$ is a partial order (see \sheetref{partial_orders}{Partial Orders}).\footnote{Future editions will include more formal accounts.}
