...
In other words, $\geq$ is a partial order (see \sheetref{partial\_orders}{Partial Orders}).\footnote{Future editions will include more formal accounts.}

For $d = 1$, $\geq$ reduces to the familiar total order of the real line(see \sheetref{real\_order}{Real Order}).
