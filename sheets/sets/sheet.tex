...
If the object denoted by $a$ is \say{a part of} a the set denoted by $A$, and the set denoted by $A$ is \say{a part of} the set denoted by $B$, then usual English usage would suggest that $a$ is \say{a part of} the set denoted by $B$.
