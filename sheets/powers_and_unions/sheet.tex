...
\begin{proposition}
$\powerset{E} \cup \powerset{F} \subset \powerset{(E \cup F)}$\end{proposition}
\begin{proposition}
$\bigcup_{X \in \mathcal{C} } \powerset{X} \subset \powerset{(\bigcup_{X \in \mathcal{C} } X)}$\end{proposition}
\begin{proposition}
$E = \bigcup \powerset{E}$\end{proposition}
\begin{proposition}
$\powerset{(\bigcup E)} \supset E$.\end{proposition}
