...
In other words, for all $B \subset A$, $\chi _{B}^{-1}(\set{1}) = B$.\footnote{Another notation used, when referring to these as \say{indicator functions,} is $1_{B}: A \to \set{0, 1}$ or $\mathbf{1}_B$.}
