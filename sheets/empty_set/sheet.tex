...
The principle of extension (see \sheetref{set_equality}{Set Equality}) says that the set obtained is unique (contradiction).
...
In other words, in all future accounts (see \sheetref{accounts}{Accounts}), there are two implicit lines. First, \say{\texttt{name} $\varnothing$} and second \say{\texttt{have} $(\forall x)(x \not\in \varnothing)$}.
