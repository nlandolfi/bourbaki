...
\ssection{Correspondence with $\Z$}
...
\ssection{Signed integers}\footnote{Future editions will include an account of signed integers, or will place this in another sheet.}
