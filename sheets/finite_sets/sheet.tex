...
This justifies the language \say{principle of infinity} with \sheetref{natural_numbers}{Natural Numbers}.
The principle of infinity asserts the existence of a particular infinite set; namely $\omega$.

\ssection{Motivation for set number}
...
\ssection{Subsets of finite sets}
...
\ssection{Unions of finite sets}

\begin{proposition}
	if $A$ and $B$ are finite, then $A \union B$ is finite.
\end{proposition}

\ssection{Products of finite sets}
...
\ssection{Powers of finite sets}

\begin{proposition}
	If $A$ is finite then $\powerset{A}$ is finite.
\end{proposition}

\ssection{Functions between finite sets}
