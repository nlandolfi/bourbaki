...
% s of vectors to the a linear combination of the results of the individual vectors in the combination the result of a linear combination of two vectors in the first space is the linear combination (with the same coefficients) of the result in the second space.
