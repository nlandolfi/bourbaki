...
To each topological numbering $\sigma $ of $(V, F)$ (see \sheetref{directed\_path}{Directed Paths}) there exists an ordered undirected graph $((V, E), \sigma )$ where $(V, E)$ is the skeleton of $(V, F)$.
