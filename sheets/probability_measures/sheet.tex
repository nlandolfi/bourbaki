...
Let $(X, \mathcal{A} )$ be a measurable space.\footnote{Often, other authors will denote the set of outcomes (here denoted by $X$) by $\Omega $, an apparent mnemonic for \say{outcomes}.}
...
Thus, we often say \say{Let $(X, \mathcal{A} , \mathbfsf{P} )$ be a probability space.}
