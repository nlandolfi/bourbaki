...
The word \say{space} is natural, since we developed measure theory partly as a generalization of volume in three-dimensional space (see \sheetref{real_space}{Real Space} and \sheetref{n-dimensional_space}{N-Dimensional Space}).
