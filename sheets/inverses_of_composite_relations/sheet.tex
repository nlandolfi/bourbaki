...
\begin{proposition}
$R$ is symmetric if and only if $R \subset R^{-1}$\end{proposition}
\begin{proposition}
$R$ is reflextive if and only if $I \subset R$\end{proposition}
\begin{proposition}
$R$ is transitive if and only if $RR \subset R$.\end{proposition}
\blankpage