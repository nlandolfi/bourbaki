...
We denote set the real-valued integrable functions on $X$ by $\mathcal{I} (X, \mathcal{A} , \mu , \R )$, read aloud as \say{the real integrable functions on the measure space X script A mu.}
We denote set the complex-valued integrable functions on $X$ by $\mathcal{I} (X, \mathcal{A} , \mu , \C )$, read aloud as \say{the complex integrable functions on the measure space X script A mu.}
When the field is irrelevant, we denote them by $\mathcal{I} (X, \mathcal{A} , \mu )$, read aloud as \say{integrable functions on the measure space X script A mu.}
The $\mathcal{I} $ is a mnemonic for \say{integrable.}
