...
Given a plane, there exists a set of its (infinite) lines.\end{principle}
...
There exists a one-to-one correspondence mapping elements of $\cup L$ onto elements of $\R ^2$.\end{principle}
