...
A parametric distribution network family is \t{functionally} if each of the conditionals is functionally parameterizable (again, see \sheetref{parameterized_distributions}{Parameterized Distributions}).
