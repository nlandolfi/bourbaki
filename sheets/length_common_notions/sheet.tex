...
The task is to make precise the use of \say{whole,}, \say{parts,}
and \say{contains.}
...
The length of an interval is the difference of its endpoints: the larger minus the smaller (see \sheetref{interval_length}{Interval Length}).
Two intervals are \t{non-overlapping} if their intersection is a single point or empty.
The \ct{length} of the union of two non-overlapping intervals is the sum of their lengths.
