...
Let $a$ denote an object and $b$ denote an object.
Let us suppose that these two objects are the same object in the set of the sheet \sheetref{identities}{Identity}.
...
We agree that $\in$ means \say{belongs to} in the sense of \say{is an element of} or \say{is a member of} as given in \sheetref{sets}{Sets}.
