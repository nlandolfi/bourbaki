...
Other terminology for probability distribution includes \t{distribution}, \t{probability mass function}, \t{pmf}, \t{proportion distribution}, and \t{probabilities}.\footnote{Many authors reserve the term \textit{probability mass function} for the case in which $\Omega  = \R $.}
