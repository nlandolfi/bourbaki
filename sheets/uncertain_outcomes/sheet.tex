...
%<div data-littype='run'> ‹A model for flipping a coin›. </div> 
...
%<div data-littype='run'> ‹A model for rolling a die›. </div> 
...
\subsubsection*{A model for rolling two dice at once}


%<div data-littype='run'> ‹A model for rolling two dice at once›. </div> 
...
%<div data-littype='run'> ‹A model for rolling one die twice›. </div> 
