...
The content of our assertions will be logical statements (see \sheetref{logical\_statements}{Logical Statements}) and when we want to make them for all objects or for no object we will use the following symbols.
