...
A \t{probability density} or \t{probability density function} is a real-valued function from a set of outcomes which is non-negative and normalized.
A real-valued function on measurable space is \ct{normalized} if the measure if its integral over the space is 1.
