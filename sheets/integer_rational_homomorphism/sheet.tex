...
\begin{proposition}
The rings $(\tilde{\Q }, +_{\Q } \mid \tilde{\Q }, \cdot _{\Q } \mid \tilde{\Q })$ and $(Z, +_{\Z }, \cdot _{\Z })$ are homomorphic.\footnote{Indeed, more is true and will be included in future editions. There is an \textit{order perserving} ring homomorphism.}\end{proposition}
