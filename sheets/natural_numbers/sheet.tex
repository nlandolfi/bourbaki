...
In \sheetref{successor_sets}{Successor Sets},
we said \say{and we continue as usual using the English language...} in our definition of zero, and one and two and three.
...
\begin{principle}[Natural Numbers]A set which contains 0 and contains the successor of each of its elements exists.\end{principle}
