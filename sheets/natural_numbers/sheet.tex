...
In \sheetref{successor_sets}{Successor Sets}, we said \say{and we continue as usual using the English language...} in our definition of zero, and one and two and three.
...
We often denote elements of $\omega $ or $\N  $ by $n$, a mnemonic for number, or $m$, the letter before $m$ in the conventional ordering of the Latin alphabet (see \sheetref{letters}{Letters}).
