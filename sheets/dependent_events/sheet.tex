...
Two events are $A = \Set{\omega  \in \Omega }{ \omega _1 + \omega _2 > 5}$, \say{the sum is greater than 5}, and $B = \Set{\omega  \in \Omega }{\omega _1 > 3}$, \say{the number of pips on the first die in greater than 3}.
Then $\mathbfsf{P} (A) = \nicefrac{26}{36}$.
