...
The matrix which is the identity under the operation of multiplication is the one which has ones on its diagonals and zero elswhere.\footnote{Future editions will improve and expand.}
We denote the $d \times  d$ identity matrix by $I_d$, or, when no confusion is possible by $I$.
