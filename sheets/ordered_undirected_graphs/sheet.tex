...
\section*{Why\footnote{Future editions will include. This sheet is needed, for example, in discussing perfect elimination orderings.}}

\section*{Definition}

An \t{ordering} of an undirected graph is an ordering (see \sheetref{lists}{Lists}) of its vertices.
...
\begin{center}\includegraphics[width=0.50\textwidth]{./graphics/ordered_undirected_graph.pdf}\end{center}