...
The covariance of $x$ summarizes how ``wide'' the induced distribution of $x$ is.
If the covariance is small, then the induced distribution is concentrated around its mean.\footnote{Future editions will give example.}
