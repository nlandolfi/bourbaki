...
\sheetref{alphabets}{Alphabets}
(\ref{sheets:alphabets})
\\
...
\textit{ finite sequence, list, length, in, string, list, ordering, numbering, index, natural direct product, $n$-tuple, tuple, infinite sequence, $n$th term, coordinate, index range, slice.}
...
\sheetref{controlled_dynamical_systems}{Controlled Dynamical Systems}
(\ref{sheets:controlled_dynamical_systems})
\\
