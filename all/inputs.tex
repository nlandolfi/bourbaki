...
\textit{ group, algebra, commutative group, abelian group, zero ring.}
...
\sheetref{compact_sets}{Compact Sets}
(\ref{sheets:compact_sets})
\\
...
\textit{ less than or equal to, less than, less than or equal to.}
...
\sheetref{real_subspaces}{Real Subspaces}
(\ref{sheets:real_subspaces})
\\
