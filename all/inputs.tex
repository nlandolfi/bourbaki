...
\textit{ object, tangible, intangible, abstract.}
...
\sheetref{real_convex_hulls}{Real Convex Hulls}
(\ref{sheets:real_convex_hulls})
\\
...
\sheetref{marked_graphs}{Marked Graphs}
(\ref{sheets:marked_graphs})
\\
...
\sheetref{convex_multivariate_functions}{Convex Multivariate Functions}
(\ref{sheets:convex_multivariate_functions})
\\
...
\textit{ $n$-tuples, sequences, direct product, Cartesian product, family Cartesian product, function of several variables, function of two variables, consecutive, projection, projection of $a$ onto index $j$, $j$-coordinate, coordinate.}
...
\sheetref{invertible_linear_transformations}{Invertible Linear Transformations}
(\ref{sheets:invertible_linear_transformations})
\\
...
\sheetref{natural_number_notation}{Natural Number Notation}
(\ref{sheets:natural_number_notation})
\\
...
\stitle{Finite Set Examples}{finite_set_examples}
\input{../sheets/finite_set_examples/macros.tex}
\input{../sheets/finite_set_examples/sheet.tex}
\clearpage
...
\clearpage\gpage{../sheets/finite_set_examples/graph.pdf}
...
\stitle{Natural Arithmetic}{natural_arithmetic}
\input{../sheets/natural_arithmetic/macros.tex}
\input{../sheets/natural_arithmetic/sheet.tex}
\clearpage
...
\clearpage\gpage{../sheets/natural_arithmetic/graph.pdf}
...
\sheetref{subgroups}{Subgroups}
(\ref{sheets:subgroups})
\\
...
\textit{ group, commutative group, abelian group, finite group, zero ring, group operations.}
...
\sheetref{ring_ideals}{Ring Ideals}
(\ref{sheets:ring_ideals})
\\

\sheetref{semirings}{Semirings}
(\ref{sheets:semirings})
\\
...
\textit{ ring, ring with identity, additive identity, multiplicative identity, additive inverses, ring addition, ring multiplication, commutative ring, division ring, zero ring, trivial ring, zero ring.}
...
\textit{ field, field addition, field multiplication, field operations.}
...
\sheetref{real_set_closures}{Real Set Closures}
(\ref{sheets:real_set_closures})
\\
...
\sheetref{length_measure}{Length Measure}
(\ref{sheets:length_measure})
\\
...
\sheetref{area_measure}{Area Measure}
(\ref{sheets:area_measure})
\\
...
\sheetref{volume_measure}{Volume Measure}
(\ref{sheets:volume_measure})
\\
...
\sheetref{n-dimensional_volume_measure}{N-Dimensional Volume Measure}
(\ref{sheets:n-dimensional_volume_measure})
\\
...
\sheetref{real_affine_transformations}{Real Affine Transformations}
(\ref{sheets:real_affine_transformations})
\\
...
\sheetref{discrete_metric}{Discrete Metric}
(\ref{sheets:discrete_metric})
\\
...
\sheetref{continuous_linear_transformations}{Continuous Linear Transformations}
(\ref{sheets:continuous_linear_transformations})
\\
...
\stitle{Topologies}{topologies}
\input{../sheets/topologies/macros.tex}
\input{../sheets/topologies/sheet.tex}
\clearpage
...
\clearpage\gpage{../sheets/topologies/graph.pdf}
