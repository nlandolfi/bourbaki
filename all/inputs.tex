...
\newpage
\label{natural_families}
\refstepcounter{sheets}
\label{sheets:natural_families}
\hypertarget{natural_families}{}
\stitle{Natural Families}{natural_families}
\input{../sheets/natural_families/macros.tex}
\input{../sheets/natural_families/sheet.tex}
\clearpage
...
\clearpage\gpage{../sheets/natural_families/graph.pdf}
