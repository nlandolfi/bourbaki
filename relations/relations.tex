...
$R$ is \definition{reflexive} if $(a, a) \in R$ for all $a \in A$.
$R$ is \definition{transitive} if $(a, b) \in R \land (b, c) \in R \implies (a, c) \in R$ for all $a, b, c \in A$.
$R$ is \definition{symmetric} if $(a, b) \in R \implies (b, a) \in R$ for all $a, b \in A$.
$R$ is \definition{anti-symmetric} if $(a, b) \in R \implies (b, a) \not\in R$ for all $a, b \in A$.
